    ...
    public partial class initialmigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeguidorUsuarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeguidorUsuarios_AspNetUsers_SeguidoId",
                        column: x => x.SeguidoId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeguidorUsuarios_AspNetUsers_SeguidorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConversacionUsuarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConversacionUsuarios_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConversacionUsuarios_Conversaciones_ConversacionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoriaVistas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoriaVistas_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PublicacionLikes_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comentarios_PublicacionId_FechaComentario",
                table: "Comentarios",
                columns: new[] { "PublicacionId", "FechaComentario" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversacionUsuarios_ConversacionId_UsuarioId",
                table: "ConversacionUsuarios",
                columns: new[] { "ConversacionId", "UsuarioId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ConversacionUsuarios_UsuarioId",
                table: "ConversacionUsuarios",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Historias_UsuarioId_FechaExpiracion",
                table: "Historias",
                columns: new[] { "UsuarioId", "FechaExpiracion" });

            migrationBuilder.CreateIndex(
                name: "IX_HistoriaVistas_HistoriaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoriaVistas_UsuarioId_HistoriaId",
                table: "HistoriaVistas",
                columns: new[] { "UsuarioId", "HistoriaId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Publicaciones_UsuarioId_FechaSubida",
                table: "Publicaciones",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeguidorUsuarios_SeguidoId",
                table: "SeguidorUsuarios",
                column: "SeguidoId");

            migrationBuilder.CreateIndex(
                name: "IX_SeguidorUsuarios_SeguidorId_SeguidoId",
                table: "SeguidorUsuarios",
